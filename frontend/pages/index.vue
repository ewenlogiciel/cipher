  ...
  <div>
    ...
    <div v-else class="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2">
      <div
        ...
        :key="vault.id"
        class="group relative rounded-xl border border-white/[0.06] bg-surface-50 p-5 transition-all duration-200 hover:border-white/[0.1] hover:bg-surface-100 cursor-pointer"
      >
